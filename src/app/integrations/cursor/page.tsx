...
export default function CursorIntegrationPage() {
  return (
    <AgentIntegrationPage
      ...
      prompts={[
        'Call search_oneway_flights for TLV to JFK on October 13 and show me the raw JSON so we can write a parser for it.',
        'Fetch live fares for LIS to JFK across November and build a test fixture from the five cheapest days.',
        'Add a fareVerdict helper that maps price_range_in_relation_to_other_periods to a badge color, then check it against a live TLV to LHR search.',
