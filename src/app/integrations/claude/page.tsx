...
export default function ClaudeIntegrationPage() {
  return (
    <AgentIntegrationPage
      ...
      prompts={[
        'Find me a nonstop TLV to JFK flight on October 13 and tell me if the price is any good.',
        'What is the cheapest day to fly Lisbon to New York in November?',
        'I need a round trip TLV to Paris, out October 6, back October 13. What are my best-value options?',
