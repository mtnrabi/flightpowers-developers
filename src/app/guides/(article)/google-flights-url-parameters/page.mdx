...
export const metadata = withOg({
  title: 'Google Flights search URL format: parameters',
  description:
    'The tfs= parameter is a base64url protobuf holding origin, destination, dates, cabin and stops. Decode it with protoc --decode_raw. Plus q= and curr=.',
