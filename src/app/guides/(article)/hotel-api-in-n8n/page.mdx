...
- **Multi-market rate parity.** Same hotel, three requests with different `proxy_country` values (`"proxy_country": "US"`, `"proxy_country": "DE"`, `"proxy_country": "IL"`), and you have the full competitive pricing picture. The pattern is written up in [How to monitor hotel rate parity](/guides/monitor-hotel-rate-parity).
...
- [How to monitor hotel rate parity](/guides/monitor-hotel-rate-parity): the multi-market pattern, documented and proven
