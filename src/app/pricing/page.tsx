...
export const metadata: Metadata = {
  ...
  description:
    'Flights: free tier, then $10 / $25 / $50 per month with 150–500 requests/minute. Hotels: free tier, then $10 / $20 / $50. Every plan includes every endpoint; compare $ per 1,000 requests. Billing is on RapidAPI — no new vendor to onboard.',
...
const faq: Faq[] = [
  ...
  },
  {
    ...
    a: 'No. All public plans on both listings have request-approval disabled — subscribing is immediate, and the free tier needs no card.',
  },
  {
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2 max-w-4xl">
          <div className="rounded-2xl border rule bg-ink-900/60 p-6">
            ...
            <p className="mt-2 text-[14.5px] text-ink-400 leading-relaxed">
              ...
              as an actor. Pay-per-event; see the event table on the listing for current rates.
            </p>
